...
Se encuentran disponibles en la carpeta  [samples](https://github.com/Sysadmins-CENIA/Cluster-IALab-Docs/tree/main/assets/samples).
...
Para un mayor control sobre los trabajos, vea la [documentación de sbatch](https://slurm.schedmd.com/sbatch.html){:target="_blank"}.
